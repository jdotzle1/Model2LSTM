...
def test_xgboost_training(df_featured):
    ...
    from project.data_pipeline.pipeline import train_xgboost_models, PipelineConfig
...
def test_chunked_processing():
    ...
    from project.data_pipeline.pipeline import process_labeling_and_features, PipelineConfig
